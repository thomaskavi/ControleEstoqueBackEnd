...
public class RoupaService {
  ...
  public Roupa atualizarRoupa(Long id, Roupa roupaAtualizada) {
    Roupa roupaExistente = roupaRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Roupa não encontrada"));
    ...
    if (roupaAtualizada.getContatoFornecedor() != null) {
      roupaExistente.setContatoFornecedor(roupaAtualizada.getContatoFornecedor());
    }
